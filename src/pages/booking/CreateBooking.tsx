        ...
        <Card className="mx-auto mb-10 w-3/4 grow">
          ...
          <div className="mt-3 grid grid-cols-3 gap-y-5">
            ...
            <div>
              Seats Booked
              <div className="font-semibold">
                {departureInfo.total_tickets} out of{" "}
          ...
          <div className="mt-12 border-t pt-8">
            ...
            <div className="mx-auto mt-10 w-1/2 border py-5">
              <div>
                ...
                <div className="mt-5 border-b" style={{ width: "24%" }}></div>
              </div>

              <div
                className={`${
                  user && !kycInfo?.is_kyc_verified ? "pointer-events-none" : ""
              ...
              <div className="mt-10 border-t pt-5">
                ...
                <form method="POST" onSubmit={handlePayment}>
                  ...
                  <div className="mx-auto w-3/4">
                    <PrimaryButton className="mt-10" loading={payNowLoading}>
                      Pay Now
                    </PrimaryButton>
                  </div>
                </form>
