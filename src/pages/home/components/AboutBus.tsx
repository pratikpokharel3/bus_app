...
const AboutBus = () => {
  return (
    <div className="mx-auto mt-44 w-3/4">
      <Heading1 className="text-center">About Bus</Heading1>
      ...
      <div className="mt-10 grid grid-cols-3 gap-x-10">
        <div className="flex flex-col items-center">
          ...
          <span className="mt-3 font-semibold">Free Wi-Fi</span>

          <div className="mt-3 text-sm text-gray-500">
            We provide free Wi-Fi bus service so that you can watch your
            favourite movies, TV shows, cartoons, etc. when travelling with us.
          </div>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="mt-3 font-semibold">Comfortable Seats</span>

          <div className="mt-3 text-sm text-gray-500">
            We take great priority to customer welfare. Our buses are designed
            to be comfy so you can relax when travelling long distances.
          </div>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="mt-3 font-semibold">Free Snacks</span>

          <div className="mt-3 text-sm text-gray-500">
            We provide free snacks to our customers when travelling. This
            includes water bottle, sweets, chips, etc. as per customers choice.
          </div>
        </div>
      </div>
    </div>
